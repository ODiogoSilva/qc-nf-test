class Help {
    ...
    static def print_help(Map params) {
        ...
        println "       "
        println "       Component 'FASTQC_1_3'"
        println "       ----------------------"
        println "       --adapters_1_3              Path to adapters files, if any. (default: 'None')"
        println "       "
        println "       Component 'CHECK_COVERAGE_1_4'"
        println "       ------------------------------"
        println "       --genomeSize_1_4            Genome size estimate for the samples. It is used to estimate the coverage and other assembly parameters andchecks (default: 2.1)"
        println "       --minCoverage_1_4           Minimum coverage for a sample to proceed. Can be set to0 to allow any coverage (default: 15)"
